...
from data_v11 import strain_list,consequence_list
...
class InputForm_gui_v20(Form):
    ...
    view = fields.SelectField(label='View ', choices=viewchoices,default='1')
    ...
    strainp1new   = fields.SelectField(label=' of S1',choices= strain_list, default='9')
    strainp2new   = fields.SelectField(label=' with S2',choices= strain_list, default='10')
    ...
    consequence = fields.SelectMultipleField(label='With consequences',choices= consequence_list,default=[])
    
    
    ######### Advanced Options #############
    strainpairlist= fields.TextAreaField(label='Strain pair list',default='CC001-CC002,CC003-CC004')
