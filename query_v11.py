...
def generatequery_gui_v11(variantinputtype='2', view='1',
                           variant_id="1,2,3",variantfile= None,
...
if __name__ == '__main__':
    print generatequery_gui_v11(variantinputtype='3', view='1', variant_id="1,2,3",variantfile= None, chr='ALL',strnum=30000000,endnum=31000000, bedfile=None, genesearch = "ENSMUSG00000044072,ENSMUSG00000020315", genefile= None, selectCollum1 =["variant_id","chrom","pos","strain_name","allele","prob","is_max","consequence","gene_name","transcript_name"],selectCollum2 =[],selectCollum3= [],selectCollum4= [], prob_cutoff = 0.5, ismax = 1,homo = 'ALL',consequence_list = ['1','2'], strainlistnew = ['1','2','3','4','5','6','7','8'], strainp1new = [], strainp2new = [], limnum = 100)
