...
from data_v10 import strain_list,consequence_list
...
class InputForm_gui_v10(Form):
    ...
    variant_id_text= fields.TextAreaField(label='Comma separated ILVDB variant IDs',default='Comma separated ISVDB variant IDs')
    #variantfile = fields.FileField('Upload variant_id file(Unavailable)')

    chr = fields.SelectField(label='Chrom', choices=chrom_list_choice,default='19')
    ...
    strainlistnew = fields.SelectMultipleField(label='Of strains',choices= strain_list, default=['1','2','3','4','5','6','7','8','9'])
    strainp1new   = fields.SelectField(label=' of S1',choices= strain_list, default='8')
    strainp2new   = fields.SelectField(label=' with S2',choices= strain_list, default='3')
